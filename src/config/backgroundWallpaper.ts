...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		desktop: [
			"assets/images/DesktopWallpaper/wallhaven-3q2rj6.jpg",
			"assets/images/DesktopWallpaper/wallhaven-5y3571.jpg",
			"assets/images/DesktopWallpaper/夏日.jpg",
		],
		// 移动背景图片（支持单张或多张随机）
